...
exports.SchedulePage = class SchedulePage {
    constructor(page) {
      ...
      this.scheduleTab=this.isMobile?this.page.locator("//app-mobile-navigation//div[5]/app-mobile-navigation-item//icon"):this.page.locator("//span[normalize-space()='Schedule']")
      this.myScheduleTab=this.isMobile?this.page.locator("//div[@role='tab'][1]//app-label-with-number/div/div[normalize-space()='My Schedule']"):this.page.locator("//mat-button-toggle-group/mat-button-toggle[1]//button//span[normalize-space()='My Schedule']")
      this.errorMessage=this.page.locator("//span[contains(text(),'users who have a valid EmployeeId')]")
    }
    async actionsOnSchedule(){
        await this.scheduleTab.waitFor({ state: 'visible', timeout: parseInt(process.env.small_timeout) });
